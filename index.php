...
<head>
	...
	<meta name="description" content="<?php echo $sSiteTitle; ?>,পলাশ উপজেলা, নরসিংদী জেলা">
	<meta name="keywords" content="<?php echo $sSiteTitle; ?>,পলাশ উপজেলা, নরসিংদী জেলা">
	...
	<meta property="og:title" content="ঘোড়াশাল পৌরসভা,পলাশ উপজেলা, নরসিংদী জেলা">
	<meta property="og:description" content="ঘোড়াশাল পৌরসভা,পলাশ উপজেলা, নরসিংদী জেলা">
							...
							<div class="row">
										...
										<a href="#">
											...
											<div class="desc">
												<h2 class="lead-news-list-title">
													বনায়নের গাছ রক্ষার অজুহাতে শতাধিক কৃষকের সবজি গাছ কাটার অভিযোগ
												</h2>
											</div>
										</a>
									</div>
								...
								<div class="col-lg-4 col-6">
									<div class="main-news-list">
										<a href="#">
											<picture>
												<img class="img-fluid img100" src="media/imgAll/bg/lead-list-2.jpg" alt="সেপ্টেম্বরের শুরুতে ট্রায়াল রান, শেষ সপ্তাহে উদ্বোধন" title="সেপ্টেম্বরের শুরুতে ট্রায়াল রান, শেষ সপ্তাহে উদ্বোধন">
											</picture>
											<div class="desc">
												<h2 class="lead-news-list-title">
													সুন্দরবনের অভয়ারণ্য থেকে ৬ জেলে আটক, ৮ নৌকা জব্দ
												</h2>
											</div>
								...
								<div class="col-lg-4 col-6">
									<div class="main-news-list">
										<a href="#">
											<picture>
												<img class="img-fluid img100" src="media/imgAll/bg/lead-list-3.jpg" alt="সেপ্টেম্বরের শুরুতে ট্রায়াল রান, শেষ সপ্তাহে উদ্বোধন" title="সেপ্টেম্বরের শুরুতে ট্রায়াল রান, শেষ সপ্তাহে উদ্বোধন">
											</picture>
											<div class="desc">
												<h2 class="lead-news-list-title">
					...
					<div class="col-lg-4">
						<div class="national-area">
							<div class="section-heading">
								<a href="#">
									<h3 class="Title">জাতীয় <i class="fa-solid fa-angles-right"></i></h3>
								</a>
							</div>
							<div class="national-lead-news">
								<div class="main-news-list">
									<a href="#">
										<picture>
											<img class="img-fluid img100" src="media/imgAll/bg/1695865537.Phot - 2023-09-28T074530.271.jpg" alt="সেপ্টেম্বরের শুরুতে ট্রায়াল রান, শেষ সপ্তাহে উদ্বোধন" title="সেপ্টেম্বরের শুরুতে ট্রায়াল রান, শেষ সপ্তাহে উদ্বোধন">
										</picture>
										<div class="desc">
											<h2 class="lead-news-list-title">
												মঙ্গলবার যেসব এলাকায় গ্যাস সরবরাহ বন্ধ থাকবে 
											</h2>
										</div>
									</a>
								</div>
						...
						<div class="law-area">
							...
							<div class="national-lead-news">
								<div class="main-news-list">
									<a href="#">
										<picture>
											<img class="img-fluid img100" src="media/imgAll/bg/1-2e395856236b7e471a90b57590b84fad.jpg" alt="সেপ্টেম্বরের শুরুতে ট্রায়াল রান, শেষ সপ্তাহে উদ্বোধন" title="সেপ্টেম্বরের শুরুতে ট্রায়াল রান, শেষ সপ্তাহে উদ্বোধন">
										</picture>
										<div class="desc">
											<h2 class="lead-news-list-title">
		...
		<div class="advertise-section pt-3">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<picture>
							<img class="img-fluid img100" src="media/imgAll/bg/advertisement-6.jpeg" alt="জনকল্যাণে এমপিদের জীবন উৎসর্গ করার আহ্বান প্রধানমন্ত্রীর" title="জনকল্যাণে এমপিদের জীবন উৎসর্গ করার আহ্বান প্রধানমন্ত্রীর">
						</picture>
					</div>
				</div>
			</div>
					...
					<div class="row">
						...
						<div class="col-lg-4">
							<div class="bandorban-heading">
								<div class="section-heading">
									<a href="#">
										<h3 class="Title">বান্দরবান<i class="fa-solid fa-angles-right"></i></h3>
									</a>
								</div>
								<div class="parborto-chotogram-area">
									<div class="main-news-list">
										<a href="#">
											<picture>
												<img class="img-fluid img100" src="media/imgAll/bg/dinajpur-mayeor1-20231012110825.jpg" alt="সেপ্টেম্বরের শুরুতে ট্রায়াল রান, শেষ সপ্তাহে উদ্বোধন" title="সেপ্টেম্বরের শুরুতে ট্রায়াল রান, শেষ সপ্তাহে উদ্বোধন">
											</picture>
											<div class="desc">
												<h2 class="lead-news-list-title">
													এছাড়াও অন্যান্য চরিত্রে অভিনয় করেছেন দিলারা জামান
												</h2>
											</div>
										</a>
									</div>
						...
						<div class="col-lg-4">
							<div class="bandorban-heading">
								<div class="section-heading">
									<a href="#">
										<h3 class="Title">রাঙ্গামাটি<i class="fa-solid fa-angles-right"></i></h3>
									</a>
								</div>
								<div class="parborto-chotogram-area">
									<div class="main-news-list">
										<a href="#">
											<picture>
												<img class="img-fluid img100" src="media/imgAll/bg/-e2e0fb2af24cd3a1dd060da9cd3a61c9.jpg" alt="সেপ্টেম্বরের শুরুতে ট্রায়াল রান, শেষ সপ্তাহে উদ্বোধন" title="সেপ্টেম্বরের শুরুতে ট্রায়াল রান, শেষ সপ্তাহে উদ্বোধন">
											</picture>
											<div class="desc">
												<h2 class="lead-news-list-title">
													তদারকি করতে বিবাদীদের ব্যর্থতা কেন অবৈধ ও বেআইনি ঘোষণা করা হবে
												</h2>
											</div>
										</a>
									</div>
						...
						<div class="col-lg-4">
							<div class="bandorban-heading">
								<div class="section-heading">
									<a href="#">
										<h3 class="Title">খাগড়াছড়ি<i class="fa-solid fa-angles-right"></i></h3>
									</a>
								</div>
								<div class="parborto-chotogram-area">
									<div class="main-news-list">
				...
				<div class="sport-section">
					<div class="row">
						<div class="col-lg-12">
							<div class="section-heading">
								<a href="#">
									<h3 class="Title">বিনোদন<i class="fa-solid fa-angles-right"></i></h3>
								</a>
							</div>
						</div>
					</div>
							...
							<div class="col-lg-3 col-6 order-lg-3 order-2">
								<div class="entertainment-area">
									<div class="main-news-list">
										<a href="#">
											<picture>
												<img class="img-fluid img100" src="media/imgAll/bg/lead-list4.jpg" alt="সেপ্টেম্বরের শুরুতে ট্রায়াল রান, শেষ সপ্তাহে উদ্বোধন" title="সেপ্টেম্বরের শুরুতে ট্রায়াল রান, শেষ সপ্তাহে উদ্বোধন">
											</picture>
											<div class="desc">
												<h2 class="lead-news-list-title">
													সেপ্টেম্বরের শুরুতে ট্রায়াল রান, শেষ সপ্তাহে উদ্বোধন
							...
							<div class="row">
								<div class="col-lg-3 col-6">
									<div class="main-news-list">
										<a href="#">
											<picture>
												<img class="img-fluid img100" src="media/imgAll/bg/news-list-1.jpg" alt="সেপ্টেম্বরের শুরুতে ট্রায়াল রান, শেষ সপ্তাহে উদ্বোধন" title="সেপ্টেম্বরের শুরুতে ট্রায়াল রান, শেষ সপ্তাহে উদ্বোধন">
											</picture>
											<div class="desc">
												<h2 class="lead-news-list-title">
								...
								<div class="col-lg-3 col-6">
									<div class="main-news-list">
										<a href="#">
											<picture>
												<img class="img-fluid img100" src="media/imgAll/bg/lead-list-1.webp" alt="সেপ্টেম্বরের শুরুতে ট্রায়াল রান, শেষ সপ্তাহে উদ্বোধন" title="সেপ্টেম্বরের শুরুতে ট্রায়াল রান, শেষ সপ্তাহে উদ্বোধন">
											</picture>
											<div class="desc">
												<h2 class="lead-news-list-title">
								...
								<div class="col-lg-3 col-6">
									<div class="main-news-list">
										<a href="#">
											<picture>
												<img class="img-fluid img100" src="media/imgAll/bg/lead-news-2.jpg" alt="সেপ্টেম্বরের শুরুতে ট্রায়াল রান, শেষ সপ্তাহে উদ্বোধন" title="সেপ্টেম্বরের শুরুতে ট্রায়াল রান, শেষ সপ্তাহে উদ্বোধন">
											</picture>
											<div class="desc">
												<h2 class="lead-news-list-title">
													সেপ্টেম্বরের শুরুতে ট্রায়াল রান, শেষ সপ্তাহে উদ্বোধন
		...
		<section class="menu-section-9">
			<div class="container">
				<div class="lifestyle-section">
					<div class="section-heading">
						<a href="#">
							<h3 class="Title">লাইফস্টাইল<i class="fa-solid fa-angles-right"></i></h3>
						</a>
					</div>
					<div class="row">
						<div class="col-lg-6">
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="main-news-list">
										<a href="#">
											<picture>
												<img class="img-fluid img100" src="media/imgAll/bg/1696748084.Ustad-alauddin-kha-pic.jpg" alt="সেপ্টেম্বরের শুরুতে ট্রায়াল রান, শেষ সপ্তাহে উদ্বোধন" title="সেপ্টেম্বরের শুরুতে ট্রায়াল রান, শেষ সপ্তাহে উদ্বোধন">
											</picture>
											<div class="desc">
												<h2 class="lead-news-list-title">
													সেপ্টেম্বরের শুরুতে ট্রায়াল রান, শেষ সপ্তাহে উদ্বোধন
								...
								<div class="col-lg-6">
									<div class="main-news-list">
										<a href="#">
											...
											<div class="desc">
												<h2 class="lead-news-list-title">
													পুলিশ জনগণের হৃদয়ে স্থান করে নিয়েছে: আইজিপি
												</h2>
											</div>
										</a>
									</div>
								...
								<div class="col-lg-6">
									<div class="main-news-list">
										<a href="#">
											<picture>
												<img class="img-fluid img100" src="media/imgAll/bg/1697046820.BeFunky-collage (67).jpg" alt="সেপ্টেম্বরের শুরুতে ট্রায়াল রান, শেষ সপ্তাহে উদ্বোধন" title="সেপ্টেম্বরের শুরুতে ট্রায়াল রান, শেষ সপ্তাহে উদ্বোধন">
											</picture>
											<div class="desc">
												<h2 class="lead-news-list-title">
													‘পাঁচ মাস ইলিশ ধরেছি, নিষেধাজ্ঞায় নদীতে যাবো না’
												</h2>
											</div>
										</a>
									</div>
								...
								<div class="col-lg-6">
									<div class="main-news-list">
										<a href="#">
											<picture>
												<img class="img-fluid img100" src="media/imgAll/bg/1696573668.Phot - 2023-10-06T122652.790.jpg" alt="সেপ্টেম্বরের শুরুতে ট্রায়াল রান, শেষ সপ্তাহে উদ্বোধন" title="সেপ্টেম্বরের শুরুতে ট্রায়াল রান, শেষ সপ্তাহে উদ্বোধন">
											</picture>
											<div class="desc">
												<h2 class="lead-news-list-title">ট্রেনে কাটা পড়ে প্রাণ গেলো কিশোরের
												</h2>
											</div>
										</a>
									</div>
